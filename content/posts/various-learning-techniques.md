+++
date = '2026-02-17T18:08:11+05:30'
draft = false
...
3. Find where you stumble, that is your gap.
4. Go back fill the gap.
...
Mix different topics of problem types in one study session instead of focusing on one topic per session(time block). For example, you are studying maths. You learn little bit of topic 1, then topic 2 then topic 3- come back to topic 1 study it for a 30 min (may be longer), then switch to topic 2 then topic 3 and so on. You can read it in depth from [here](https://blog.alexanderfyoung.com/interleaving).
